<p align="center">
    <a href="http://dibbs-items-flow-testnet-prod.herokuapp.com/">
        <img width="400" src="dibbs-items-banner.png" />
    </a>
</p>

👋 Welcome! This demo app is designed to help you learn to build on Flow.

- dibbs Items is a **complete NFT marketplace** built with [Cadence](https://docs.onflow.org/cadence), Flow's resource-oriented smart contract programming language.
- Learn how to deploy contracts, mint NFTs, and integrate user wallets with the Flow Client Library (FCL).

## 🎬 Live Demo

Check out the [live demo of dibbs Items](http://dibbs-items-flow-testnet-prod.herokuapp.com/),
...
```sh
git clone https://github.com/onflow/dibbs-items.git
```
...
3) Visit `http://localhost:3001` and follow the instructions "Initialize the Service Account to mint dibbs Items" at the top of the webpage.
...
Visit `http://localhost:3001` to interact with your new instance of dibbs Items!
...
# The Flow address where you have deployed your dibbs Items contract.
# (usually the same Flow address as above)

NEXT_PIBLIC_CONTRACT_dibbs_ITEMS
NEXT_PUBLIC_CONTRACT_NFT_STOREFRONT
```

## Project Overview

![Project Overview](dibbs-items-diagram.png)

## 🔎 Legend

Above is a basic diagram of the parts of this project contained in each folder, and how each part interacts with the others.

### 1. Web App (Static website) | [dibbs-items/web](https://github.com/onflow/dibbs-items/tree/master/web)
...
- Ask questions on the [Flow community forum](https://forum.onflow.org/t/dibbs-items-marketplace-demo-dapp/759/5)
